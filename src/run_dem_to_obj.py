...
if __name__ == '__main__':
    tif_path = '../output_dem.tif'
    obj_path = '../output_thick.obj'
    tif_to_thick_obj(tif_path, obj_path, thickness=5)

    # mesh = o3d.io.read_triangle_mesh(obj_path)
    # mesh.compute_vertex_normals()
    # o3d.visualization.draw_geometries([mesh], window_name='Thick DEM Model')
